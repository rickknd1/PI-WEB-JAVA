 ...
 */
final class Version20250218165923 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE gamifications CHANGE type_abonnement type_abonnement INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE gamifications CHANGE type_abonnement type_abonnement VARCHAR(255) NOT NULL');
    }
}
